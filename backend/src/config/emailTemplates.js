...
Hello,</p>
<p class="text">
Use the verification code below to complete your sign-in to ${appName} for <strong>${email}</strong>.
</p>
<!-- OTP -->
...
Hi there,</p>
<p class="text">
Thanks for registering with <strong>${appName}</strong>. Please verify your email address <strong>${email}</strong> by clicking the button below.
</p>
<!-- Button -->
<table role="presentation" border="0" cellspacing="0" cellpadding="0" style="margin: 24px 0;" width="100%">
<tr>
<td align="center">
<a class="btn" href="${verifyUrl}" target="_blank" rel="noopener noreferrer">Verify Email Address</a>
</td>
</tr>
</table>
<p class="muted">
...
<p class="muted">
<a class="link" href="${verifyUrl}" target="_blank" rel="noopener noreferrer">${verifyUrl}</a>
</p>
